...
<body>
	...
	<section class="">
		<!-- File to Store -->
		<!-- section class="col-md-4 my-3 mt-5 pl-5">
			<?php
			...
			<div class="card">
			  ...
			  <div class="card-body bg-dark text-white">
			  	...
			  	<form class="my-3 pt-2" method="POST" enctype="multipart/form-data" action="save_file.php">
					<input type="file" class="bg-light rounded" name="file" size="4" required="required" />
					<br/>
		...
		<!-- File table -->
		<section class="col-md-8 my-3 pr-5">
					...
					<table id="table" class="table table-bordered table-dark table-hover">
						...
						<tbody>
							...
							<tr class="del_file<?php echo $fetch['store_id']?>">
								...
								<td class=""><a href="download.php?store_id=<?php echo $fetch['store_id']?>" class="btn btn-success">Download</a> . <button class="btn btn-danger btn_remove" type="button" id="<?php echo $fetch['store_id']?>"><span class="glyphicon glyphicon-trash"></span> Remove</button></td>
							</tr>
							<?php
								}
							?>
